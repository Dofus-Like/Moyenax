...
const FarmingPage = lazy(() =>
  import("./pages/FarmingPage").then((module) => ({
    default: module.FarmingPage,
  })),
);
const CombatPage = lazy(() =>
  import("./pages/CombatPage").then((module) => ({
    default: module.CombatPage,
  })),
);
...
const QuickCombatPage = lazy(() =>
  import("./pages/QuickCombatPage").then((module) => ({
