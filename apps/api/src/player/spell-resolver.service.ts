...
export class SpellResolverService {
   ...
   */
  resolveSpells(equippedItems: Item[], defaultSpells: Spell[], itemGrantedSpells: { itemId: string, spellId: string }[], allSpells: Spell[]): Record<string, number> {
    ...
    const families = [
        { family: SpellFamily.WARRIOR, items: ['Heaume', 'Armure', 'Bottes de fer', 'Anneau du Guerrier'] },
        { family: SpellFamily.MAGE, items: ['Chapeau de mage', 'Toge de mage', 'Bottes de mage', 'Anneau du Mage'] },
